...
search_terms = ["Security Engineer", "Application Security Engineer", "DevSecOps Engineer", "Cloud Security Engineer", "Vulnerability Management Engineer", "Product Security Engineer", "Cybersecurity Engineer", "Information Security Engineer", "AppSec Engineer", "Security Analyst"]
...
salary = "$100,000+"               # "$40,000+", "$60,000+", "$80,000+", "$100,000+", "$120,000+", "$140,000+", "$160,000+", "$180,000+", "$200,000+"
...
bad_words = ["No C2C", "No Corp2Corp", ".NET", "Embedded Programming", "PHP", "Ruby", "CNC", "polygraph", "Top Secret"]                     # (dynamic multiple search) or leave empty as []. Case Insensitive. Ex: ["word_1", "phrase 1", "word word", "polygraph", "US Citizenship", "Security Clearance"]
